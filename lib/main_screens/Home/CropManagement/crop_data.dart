...
class Crop {
  ...
  Crop({required this.name, required this.image_path, required this.details});
}

final List<Crop> allCrops = [
  Crop(
    name: "Soil Requirement",
    image_path: "assets/images/Crop manage/soil req.png",
    details: [
      DetailItem(
        title: "Description:",
        description:
            "Soybean can be grown in a variety of soil types. However, a well-drained, sandy loam to clayey soil with medium water holding capacity, rich in organic carbon, and leveled fields with near-neutral pH is ideal for harnessing maximum soybean yield. Soil with excessive salts/sodium and poorly drained conditions are not suitable for soybean.",
      ),
    ],
  ),
  Crop(
    name: "Tillage",
    image_path: "assets/images/Crop manage/tillage.png",
    details: [
      DetailItem(
        title: "Deep Ploughing:",
        description:
            "Deep summer ploughing using reversible Mould board Plough, facilitates "
            "exposing the hibernating insects to extreme heat and predatory birds as well as "
            "movement of nutrients and infiltration of soil water. Therefore, one deep "
            "ploughing once in 3-4 years, otherwise one normal ploughing in summer fo lowed "
            "by 2 criss-cross harrowing or cultivation for breaking of soil clods wi l make "
            "ideal seed bed for a good crop of soybean cultivation is recommended. Also, "
            "sub-soiling operation once in 4-5 years at an interval of 10 meter, break the "
            "compactness of the sub-soil and also facilitate infiltration of rainwater which is "
            "useful for un-interrupted crop growth even during drought period also.",
      ),
      DetailItem(
        title: "Harrowing",
        description:
      ...
      DetailItem(
        ...
        description:
            "To have sustainable soybean yield, it is very important to maintain soil health. Hence, farmers are advised to incorporate organic manure (well decomposed FYM @5-10 t/ha or Poultry Manure @ 2.5t/ha) at the time of land preparation.",
      ),
      DetailItem(
      ...
      DetailItem(
        title: "Pre monsoon ploughing:",
        description:
            "Soon after arrival of monsoon, the land may be prepared by 2 crisscross harrowings followed by planking to level the field. If the farmer is interested to apply PPI herbicide for control of weeds, this is the right time to do so.",
      ),
      DetailItem(
        title: "PPI herbicide:",
        description:
      ...
      DetailItem(
        title: "Adverse climatic conditions:",
        description:
  ...
  Crop(
    ...
    details: [
      ...
      DetailItem(
        title: "Info 3:",
        description:
            "The harvested soybean crop, after sun drying for 2-3 days is ready for threshing. Because of sowing of subsequent crop if threshing is to be performed later, the harvested soybean should be collected preferably on threshing floor and covered with tarpoline to avoid damage from rain/shattering. To maintain viability of the seed and to avoid loss/mechanical damage, threshing should be done at 350-400 гр.",
      ),
      DetailItem(
        title: "Info 4:",
        description:
  ...
  Crop(
    ...
    details: [
      ...
      DetailItem(
        title: "Info 2:",
        description:
            "Different varieties possess resistance/tolerance to particular insect-pest and diseases. As they mature at different times, it gives convenience for the farmers during harvesting and threshing too.",
      ),
      DetailItem(
        title: "Info 3:",
        description:
            "Genetically, the yield of soybean varieties is inversely proportionate with maturity period. Long-duration soybean varieties are able to give more yields subject to application of irrigation in the event of early cessation of monsoon.",
      ),
      DetailItem(
        title: "Info 4:",
        description:
  ...
  Crop(
    name: "Sowing Techniques",
    image_path: "assets/images/Crop manage/sowing teq.png",
    details: [
      DetailItem(
        title: "Flat Sowing",
        description:
            "These seed dril have provision of flat sowing 5-9 rows of soybean crop with adjustable row to row distance of 14-18 inches."),
      DetailItem(
        title: "Broad Bed Furrow (BBF)",
        description:
            "The BBF seed drils have a provision of opening the irrigation channels after an interval of 4-5 rows. The furrow mechanism is fitted on both the ends of BBF seed dri ls.",
      ),
      DetailItem(
        title: "FIRB (Furrow Irrigated Raised Bed)",
        description:
            "Seed dril developed by the institute can be used for sowing each row/paired rows on ridges",
      ),
    ],
  ),
  Crop(
    ...
    details: [
      ...
      DetailItem(
        title: "Info 4:",
        description:
            "Once the seed treatment with fungicides and insecticide is done, farmers are advised to inoculate the treated seed with bioinoculants like Bradyrhizobium japonicum and Phosphate Solubilizing Micro-organism (PSM) each @ 5 g/kg seed immediately before sowing.",
      ),
      DetailItem(
        title: "Info 5:",
        description:
      ...
      DetailItem(
        title: "Info 6:",
        description:
            "Farmers are also advised to follow correct sequence of seed treatment with recommended fungicides followed by insecticide and seed inoculation.",
      ),
      DetailItem(
        title: "Info 7:",
        description:
            "However, if Trichoderma viride has to be used, all the three bioagents can be used in one go for seed treatment.",
      ),
      DetailItem(
        title: "Info 8:",
        description:
            "They should procure these inputs (fungicides and culture) from the authentic sources and store in cool place to maintain their viability.",
      ),
    ],
  ),
  Crop(
    ...
    details: [
      DetailItem(
        title: "Info 1:",
        description:
            "Since soybean is a rainfed crop grown during the kharif season, it is sown only after the arrival of monsoon. Farmers are advised to sow their crop only after 100 mm rainfall is received to ensure germination of seed and development of the plant till the next spell of rains.",
      ),
      DetailItem(
        title: "Info 2:",
        description:
            "The sowing of soybean seed may be done either using traditional tools like bullock drawn Dufan /Tifan /seed drill or by using tractor-drawn machines like Seed-cum-Fertilizer drill, BBF Seed Drill, FIRB Seed Drill keeping row-to-row spacing of 45 cm and plant-to-plant spacing of 4-5 cm at 3 cm depth.",
      ),
      DetailItem(
        title: "Info 3:",
        description:
            "In case of delayed sowing on account of late onset of monsoon, farmers are advised to narrow the row spacing at 30 cm and increase the seed rate by 25% to optimize plant population and avert the likely yield loss due to slow growth.",
      ),
      DetailItem(
        title: "Info 4:",
        description:
            "The seed rate and germination percentage are inversely proportional to the seed size of soybean varieties. Small-seeded varieties are excellent in germination percentage compared to bold-seeded varieties.",
      ),
      DetailItem(
        title: "Info 5:",
        description:
  ...
  Crop(
    ...
    details: [
      DetailItem(
        ...
        description:
            " In order to have sustainable soybean yield, it is very important to maintain soil health. Hence, farmers are advised to incorporate organic manure (well decomposed FYM @ 5-10 t/ha or Compost @ 5 ton/ha or Poultry Manure @ 2.5 t/ha) at the time of land preparation. If the quantity of organic manure is limited, they are advised to apply the same on rotation basis in their fields every year. In case of saline soil (pH >7.5), it is also advised to apply Gypsum @ 150-200 kg/ha along with FYM/Poulty manure before the last harrowing in case the nutritional requirement is to be planned without sulphur sources for maintenance of soil pH. Similarly, in acidic soil (pH <6.5) it is advised to use lime @ 600 kg/ha.",
      ),
      DetailItem(
      ...
      DetailItem(
        ...
        description:
            "In soybean, use of fertilizers is recommended only as basal application. Therefore, farmers are advised not to use any fertilizers particularly urea or DAP as top dressing in standing crop unless being recommended by soybean scientists.x",
      ),
      DetailItem(
        title: "Fertilizer And Seed Mixing:",
        description:

...
final List<disease> diseaseTypes = [
  disease(
    ...
    image_path: "assets/images/Disease manage/bacterial dis.jpg",
  ),
  disease(
    name: "Fungal Diseases",
    image_path: "assets/images/Disease manage/fungal dis.jpg",
  ),
  disease(
    name: "Viral Diseases",
    image_path: "assets/images/Disease manage/viral dis.jpg",
  ),
];
...
final List<bacterial> allbacterialDisease = [
  bacterial(
    ...
    symptoms: "",
    management: "",
    image_path: 'assets/images/Disease manage/bacterial blight.jpg',
  ),
  bacterial(
    ...
    image_path: 'assets/images/Disease manage/bacterial pustule.jpg',
  ),
];
...
final List<fungal> allfungalDisease = [
  fungal(
    ...
    image_path: 'assets/images/Disease manage/charcoal root.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/collar_rot.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/sclerotina stem root.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/Anthracnose pod_blight.jpg',
  ),
  fungal(
    name: "Rust",
    ...
    image_path: 'assets/images/Disease manage/rust.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/choanephora leaf blight.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/frogeye leaf_spot.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/cercospora.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/pod stem decay.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/fusarium.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/myrothecium.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/root_rot.jpg',
  ),
  fungal(
    name: "Brown Spot",
    ...
    image_path: 'assets/images/Disease manage/brown_spot.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/phyllosticta leaf spot.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/aristastoma.jpg',
  ),
  fungal(
    name: "Powdery Mildew",
    ...
    image_path: 'assets/images/Disease manage/powdery mildew.jpg',
  ),
  fungal(
    ...
    image_path: 'assets/images/Disease manage/target leaf spot.jpg',
  ),
];
...
final List<viral> allviralDisease = [
  viral(
    ...
    image_path: 'assets/images/Disease manage/soybean mosaic.jpg',
  ),
  viral(
    name: "Yellow Mosaic",
    ...
    image_path: 'assets/images/Disease manage/yellow mosaic.jpg',
  ),
  viral(
    ...
    image_path: 'assets/images/Disease manage/indian_bud_blight.jpg',
  ),
  viral(
    ...
    image_path: 'assets/images/Disease manage/phyllody.jpg',
  ),
];

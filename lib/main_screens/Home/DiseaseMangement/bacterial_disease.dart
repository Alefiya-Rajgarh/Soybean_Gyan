...
class BacterialDisease extends StatefulWidget {
  const BacterialDisease({super.key});

  @override
  State<BacterialDisease> createState() => _BacterialDiseaseState();
}

class _BacterialDiseaseState extends State<BacterialDisease> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView.builder(
          ...
          itemCount: allbacterialDisease.length,
          itemBuilder: (context, index) {
            final disease = allbacterialDisease[index];
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => bacterialDetail(disease: disease),
                  ),
                );
              },
              child: Container(
...
// details screen for bacterial diseases
class bacterialDetail extends StatelessWidget {
  final bacterial disease;
  const bacterialDetail({super.key,required this.disease});
        ...
        body: NestedScrollView(
          ...
          body:  TabBarView(
            children: originalTabTitles.map((title) {
              ...
              return Padding(
                padding: const EdgeInsets.only(top: 80), // <--- KEY CHANGE

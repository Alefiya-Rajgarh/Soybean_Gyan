...
class fungalDisease extends StatefulWidget {
  const fungalDisease({super.key});

  @override
  State<fungalDisease> createState() => _fungalDiseaseState();
}

class _fungalDiseaseState extends State<fungalDisease> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView.builder(
          ...
          itemCount: allfungalDisease.length,
          itemBuilder: (context, index) {
            final disease = allfungalDisease[index];
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => fungalDetails(disease: disease),
                  ),
                );
              },
              child: Container(
...
// details screen for fungal diseases
class fungalDetails extends StatelessWidget {
  final fungal disease;
  const fungalDetails({super.key, required this.disease});
